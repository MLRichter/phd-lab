...
def mpnet36_8_1_3_11d2(num_classes, noskip=False, **kwargs):
    model = MPNet(
        stage_seq=[2, 2, 2, 2],
        block_layout=[8, 1],
        layout_kernels=[3, 11],
...
def mpnet18_8_1_3_11d2(num_classes, noskip=False, **kwargs):
    model = MPNet(
        stage_seq=[1, 1, 1, 1],
        block_layout=[8, 1],
        layout_kernels=[3, 11],
