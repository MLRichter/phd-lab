...
def vit_12_128(num_classes=10, img_size=256, **kwargs):
    model = ViT(img_dim=img_size, in_channels=3, patch_dim=img_size//16, num_classes=num_classes, dim=128, blocks=12)
    model.name = "ViT_12_128"
    return model
