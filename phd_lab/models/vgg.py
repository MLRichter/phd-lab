...
cfg = {
    ...
    'AXXL': [512, 'M', 1024, 'M', 2048, 2048, 'M', 4096, 4096, 'M', 4096, 4096, 'M'],
    ...
    'BXXL': [512, 512, 'M', 1024, 1024, 'M', 2048, 2048, 'M', 4096, 4096, 'M', 4096, 4096, 'M'],
    ...
    'DXXL': [512, 512, 'M', 1024, 1024, 'M', 2048, 2048, 2048, 'M', 4096, 4096, 4096, 'M', 4096, 4096, 4096, 'M'],
    ...
    'EL':  [128, 128, 'M', 256, 256, 'M', 512, 512, 512, 512, 'M', 1024, 1024, 1024, 1024, 'M', 1024, 1024, 1024, 1024, 'M'],
