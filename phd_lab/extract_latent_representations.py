...
@click.option("--downsample", type=int, default=4, required=False, help="downsample size of the feature map")
def main(config: str, device: str, run_id: str, downsample: int):
